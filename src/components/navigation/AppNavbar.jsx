...
import { Menu, X, ChevronDown, User, LogOut, BarChart3, Award, AlertTriangle } from 'lucide-react';
      ...
      <nav className="relative">
        <div className="relative bg-[#171717] backdrop-blur-xl border border-[#2A2A2A] rounded-full px-6 py-3 shadow-2xl">
          <div className="flex items-center gap-8">
            <Link to={createPageUrl('Dashboard')} className="flex items-center gap-2 font-semibold text-base group">
