...
const AP_SUBJECTS = {
  'Sciences': [
    ...
    { id: 'physics_c_em', name: 'AP Physics C: E&M', emoji: '🔌' },
  ...
  'History & Social Studies': [
    ...
    { id: 'comp_gov', name: 'AP Comparative Gov', emoji: '⚖️' },
  ...
  'World Languages': [
    { id: 'spanish_lang', name: 'AP Spanish Language', emoji: '🇪🇸' },
    { id: 'french_lang', name: 'AP French Language', emoji: '🇫🇷' },
...
const UNITS_BY_SUBJECT = {
  ...
  physics_c_em: [
    { id: 'unit1', name: 'Electrostatics', emoji: '⚡', keywords: ["Coulomb's law", 'electric field', 'Gauss law', 'potential'] },
    { id: 'unit2', name: 'Conductors & Capacitors', emoji: '🔋', keywords: ['capacitance', 'dielectrics', 'conductors'] },
    { id: 'unit3', name: 'Electric Circuits', emoji: '🔌', keywords: ['Kirchhoff', 'RC circuits', 'resistance'] },
    { id: 'unit4', name: 'Magnetic Fields', emoji: '🧲', keywords: ['Biot-Savart', 'Ampere', 'magnetic force'] },
    { id: 'unit5', name: 'Electromagnetism', emoji: '🌀', keywords: ['Faraday', 'Lenz', 'inductance', 'Maxwell'] },
  ],
  european_history: [
    { id: 'unit1', name: 'Renaissance & Exploration', emoji: '🎨', keywords: ['humanism', 'printing press', 'Age of Exploration'] },
    { id: 'unit2', name: 'Reformation', emoji: '⛪', keywords: ['Luther', 'Calvin', 'Protestant Reformation', 'Catholic Reformation'] },
    { id: 'unit3', name: 'Absolutism & Constitutionalism', emoji: '👑', keywords: ['Louis XIV', 'divine right', 'English Civil War'] },
    { id: 'unit4', name: 'Scientific Revolution & Enlightenment', emoji: '🔭', keywords: ['Newton', 'Locke', 'Voltaire', 'philosophes'] },
    { id: 'unit5', name: 'French Revolution & Napoleon', emoji: '🇫🇷', keywords: ['Estates', 'Reign of Terror', 'Napoleon', 'Congress of Vienna'] },
    { id: 'unit6', name: 'Industrialization', emoji: '🏭', keywords: ['factory system', 'urbanization', 'capitalism', 'socialism'] },
    { id: 'unit7', name: 'Nationalism & Imperialism', emoji: '🌍', keywords: ['unification', 'imperialism', 'Bismarck', 'scramble for Africa'] },
    { id: 'unit8', name: 'WWI & Interwar', emoji: '⚔️', keywords: ['alliance system', 'trench warfare', 'Treaty of Versailles', 'Great Depression'] },
    { id: 'unit9', name: 'WWII & Cold War Europe', emoji: '💣', keywords: ['Holocaust', 'Marshall Plan', 'NATO', 'decolonization'] },
  ],
  comp_gov: [
    { id: 'unit1', name: 'Political Systems, Regimes & Governments', emoji: '🏛️', keywords: ['regime types', 'state', 'sovereignty', 'legitimacy'] },
    { id: 'unit2', name: 'Political Institutions', emoji: '⚖️', keywords: ['legislatures', 'executives', 'judiciaries', 'bureaucracy'] },
    { id: 'unit3', name: 'Political Culture & Participation', emoji: '🗳️', keywords: ['civil society', 'political culture', 'elections'] },
    { id: 'unit4', name: 'Party & Electoral Systems', emoji: '🗳️', keywords: ['party systems', 'electoral systems', 'interest groups'] },
    { id: 'unit5', name: 'Political & Economic Change', emoji: '📈', keywords: ['democratization', 'liberalization', 'globalization'] },
    { id: 'unit6', name: 'Public Policy', emoji: '📋', keywords: ['social policy', 'economic policy', 'comparative policymaking'] },
  ],
  art_history: [
    { id: 'unit1', name: 'Global Prehistory', emoji: '🪨', keywords: ['Paleolithic', 'Neolithic', 'cave paintings', 'megaliths'] },
    { id: 'unit2', name: 'Ancient Mediterranean', emoji: '🏺', keywords: ['Egypt', 'Greece', 'Rome', 'Byzantine'] },
    { id: 'unit3', name: 'Early Europe & Colonial Americas', emoji: '⛪', keywords: ['Romanesque', 'Gothic', 'Renaissance', 'Baroque'] },
    { id: 'unit4', name: 'Later Europe & Americas', emoji: '🎨', keywords: ['Neoclassicism', 'Romanticism', 'Impressionism', 'Modernism'] },
    { id: 'unit5', name: 'Indigenous Americas', emoji: '🌿', keywords: ['Maya', 'Aztec', 'Inca', 'North American art'] },
    { id: 'unit6', name: 'Africa', emoji: '🌍', keywords: ['Benin bronzes', 'Nok', 'Yoruba', 'contemporary African art'] },
    { id: 'unit7', name: 'West & South Asia', emoji: '🕌', keywords: ['Islamic art', 'Mughal', 'Indian temple', 'Persian'] },
    { id: 'unit8', name: 'East Asia', emoji: '🏯', keywords: ['Chinese scroll', 'Japanese woodblock', 'Buddhist art', 'Zen'] },
    { id: 'unit9', name: 'Global Contemporary', emoji: '🖼️', keywords: ['postmodernism', 'installation art', 'digital art'] },
  ],
  music_theory: [
    { id: 'unit1', name: 'Music Fundamentals', emoji: '🎼', keywords: ['pitch', 'rhythm', 'meter', 'notation'] },
    { id: 'unit2', name: 'Scales & Keys', emoji: '🎹', keywords: ['major scale', 'minor scale', 'key signatures', 'modes'] },
    { id: 'unit3', name: 'Intervals & Chords', emoji: '🎸', keywords: ['intervals', 'triads', 'seventh chords', 'inversions'] },
    { id: 'unit4', name: 'Harmony & Voice Leading', emoji: '🎤', keywords: ['chord progressions', 'cadences', 'voice leading', 'part writing'] },
    { id: 'unit5', name: 'Musical Form & Analysis', emoji: '🎻', keywords: ['binary', 'ternary', 'sonata form', 'rondo'] },
  ],
  spanish_lang: [
    { id: 'unit1', name: 'Families & Communities', emoji: '👨‍👩‍👧', keywords: ['family roles', 'community life', 'traditions'] },
    { id: 'unit2', name: 'Science & Technology', emoji: '💻', keywords: ['scientific vocabulary', 'technology impact', 'innovation'] },
    { id: 'unit3', name: 'Beauty & Aesthetics', emoji: '🎨', keywords: ['art', 'literature', 'architecture', 'aesthetics'] },
    { id: 'unit4', name: 'Education & Careers', emoji: '📚', keywords: ['educational systems', 'career paths', 'workplace'] },
    { id: 'unit5', name: 'Identity & Social Issues', emoji: '🌍', keywords: ['identity', 'discrimination', 'human rights', 'social change'] },
    { id: 'unit6', name: 'Environment & Geography', emoji: '🌿', keywords: ['geography', 'climate', 'environmental issues'] },
  ],
  french_lang: [
    { id: 'unit1', name: 'Personal & Public Identities', emoji: '🧑', keywords: ['identity', 'values', 'beliefs', 'culture'] },
    { id: 'unit2', name: 'Families & Communities', emoji: '👨‍👩‍👧', keywords: ['family structures', 'community roles'] },
    { id: 'unit3', name: 'Global Challenges', emoji: '🌐', keywords: ['environmental issues', 'health', 'global inequalities'] },
    { id: 'unit4', name: 'Science & Technology', emoji: '🔬', keywords: ['innovation', 'ethics', 'digital life'] },
    { id: 'unit5', name: 'Beauty & Aesthetics', emoji: '🎭', keywords: ['French cinema', 'art', 'fashion', 'literature'] },
    { id: 'unit6', name: 'Contemporary Life', emoji: '🏙️', keywords: ['leisure', 'urbanization', 'francophone culture'] },
  ],
  latin: [
    { id: 'unit1', name: 'Latin Literature: Caesar', emoji: '⚔️', keywords: ['Gallic Wars', 'Latin prose', 'historical context'] },
    { id: 'unit2', name: 'Latin Literature: Vergil', emoji: '📜', keywords: ['Aeneid', 'epic poetry', 'Augustan ideology'] },
    { id: 'unit3', name: 'Roman Culture & Society', emoji: '🏛️', keywords: ['Roman religion', 'politics', 'daily life'] },
    { id: 'unit4', name: 'Grammar & Syntax', emoji: '📖', keywords: ['cases', 'subjunctive', 'participles', 'indirect statement'] },
  ],
  cs_principles: [
    { id: 'unit1', name: 'Creative Development', emoji: '💡', keywords: ['program design', 'collaboration', 'iterative process'] },
    { id: 'unit2', name: 'Data', emoji: '📊', keywords: ['data representation', 'data compression', 'metadata'] },
    { id: 'unit3', name: 'Algorithms & Programming', emoji: '💻', keywords: ['variables', 'conditionals', 'loops', 'functions', 'lists'] },
    { id: 'unit4', name: 'Computer Systems & Networks', emoji: '🌐', keywords: ['internet', 'protocols', 'cybersecurity', 'distributed computing'] },
    { id: 'unit5', name: 'Impact of Computing', emoji: '🤖', keywords: ['digital divide', 'bias', 'legal issues', 'crowdsourcing'] },
  ],
};
